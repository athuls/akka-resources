...
public class SimpleGlitch10Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		SimpleGlitch10Users instance = (SimpleGlitch10Users)new SimpleGlitch10Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleGlitch10Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleGlitch10Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleGlitch10Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleGlitch10Users.getReferenceByLocation(new UAL(ual)); }
	public SimpleGlitch10Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleGlitch10Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public SimpleGlitch10Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public SimpleGlitch10Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public SimpleGlitch10Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public SimpleGlitch10Users()		{  }
	public SimpleGlitch10Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.SimpleGlitch10Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public SimpleGlitch10Users self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleGlitch10Users)actorReference).setUAL(getUAL());
			((SimpleGlitch10Users)actorReference).setUAN(getUAN());
			self = new SimpleGlitch10Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.SimpleGlitch10Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 1: Poll Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 2: Poll Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 3: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 4: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 5: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 6: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 7: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 8: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 9: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 10: Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
