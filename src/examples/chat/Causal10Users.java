...
public class Causal10Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		Causal10Users instance = (Causal10Users)new Causal10Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Causal10Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Causal10Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Causal10Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Causal10Users.getReferenceByLocation(new UAL(ual)); }
	public Causal10Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public Causal10Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public Causal10Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Causal10Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Causal10Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Causal10Users()		{  }
	public Causal10Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.Causal10Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Causal10Users self;
		public void updateSelf(ActorReference actorReference) {
			((Causal10Users)actorReference).setUAL(getUAL());
			((Causal10Users)actorReference).setUAN(getUAN());
			self = new Causal10Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.Causal10Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				// s1<-broadcastSend("User 1: Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 1: Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s2<-broadcastSend("User 2: Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 2: Question "+values.get(i-1)+".", false, true, false, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s3<-broadcastSend("User 3: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 3: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s4<-broadcastSend("User 4: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 4: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s5<-broadcastSend("User 5: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 5: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s6<-broadcastSend("User 6: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 6: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s7<-broadcastSend("User 7: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 7: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s8<-broadcastSend("User 8: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 8: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s9<-broadcastSend("User 9: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 9: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s10<-broadcastSend("User 10: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true)
				{
					Object _arguments[] = { "User 10: Answer "+values.get(i-1)+".", false, false, true, num_messages, 9*num_messages, true };
