...
public class SimpleGlitchSimpleScalable1000UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		SimpleGlitchSimpleScalable1000UsersTodo instance = (SimpleGlitchSimpleScalable1000UsersTodo)new SimpleGlitchSimpleScalable1000UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleGlitchSimpleScalable1000UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleGlitchSimpleScalable1000UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleGlitchSimpleScalable1000UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleGlitchSimpleScalable1000UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public SimpleGlitchSimpleScalable1000UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleGlitchSimpleScalable1000UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public SimpleGlitchSimpleScalable1000UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public SimpleGlitchSimpleScalable1000UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public SimpleGlitchSimpleScalable1000UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public SimpleGlitchSimpleScalable1000UsersTodo()		{  }
	public SimpleGlitchSimpleScalable1000UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.SimpleGlitchSimpleScalable1000UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public SimpleGlitchSimpleScalable1000UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleGlitchSimpleScalable1000UsersTodo)actorReference).setUAL(getUAL());
			((SimpleGlitchSimpleScalable1000UsersTodo)actorReference).setUAN(getUAN());
			self = new SimpleGlitchSimpleScalable1000UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.SimpleGlitchSimpleScalable1000UsersTodo$State" );
