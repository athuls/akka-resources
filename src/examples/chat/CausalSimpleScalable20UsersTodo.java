...
public class CausalSimpleScalable20UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		CausalSimpleScalable20UsersTodo instance = (CausalSimpleScalable20UsersTodo)new CausalSimpleScalable20UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CausalSimpleScalable20UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CausalSimpleScalable20UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CausalSimpleScalable20UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CausalSimpleScalable20UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public CausalSimpleScalable20UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public CausalSimpleScalable20UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public CausalSimpleScalable20UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public CausalSimpleScalable20UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public CausalSimpleScalable20UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public CausalSimpleScalable20UsersTodo()		{  }
	public CausalSimpleScalable20UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.CausalSimpleScalable20UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public CausalSimpleScalable20UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((CausalSimpleScalable20UsersTodo)actorReference).setUAL(getUAL());
			((CausalSimpleScalable20UsersTodo)actorReference).setUAN(getUAN());
			self = new CausalSimpleScalable20UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.CausalSimpleScalable20UsersTodo$State" );
