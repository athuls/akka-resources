...
public class CausalSimpleScalableUsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		CausalSimpleScalableUsersTodo instance = (CausalSimpleScalableUsersTodo)new CausalSimpleScalableUsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CausalSimpleScalableUsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CausalSimpleScalableUsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CausalSimpleScalableUsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CausalSimpleScalableUsersTodo.getReferenceByLocation(new UAL(ual)); }
	public CausalSimpleScalableUsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public CausalSimpleScalableUsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public CausalSimpleScalableUsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public CausalSimpleScalableUsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public CausalSimpleScalableUsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public CausalSimpleScalableUsersTodo()		{  }
	public CausalSimpleScalableUsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.CausalSimpleScalableUsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public CausalSimpleScalableUsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((CausalSimpleScalableUsersTodo)actorReference).setUAL(getUAL());
			((CausalSimpleScalableUsersTodo)actorReference).setUAN(getUAN());
			self = new CausalSimpleScalableUsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.CausalSimpleScalableUsersTodo$State" );
