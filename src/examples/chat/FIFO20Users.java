...
public class FIFO20Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		FIFO20Users instance = (FIFO20Users)new FIFO20Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FIFO20Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FIFO20Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FIFO20Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FIFO20Users.getReferenceByLocation(new UAL(ual)); }
	public FIFO20Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public FIFO20Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public FIFO20Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public FIFO20Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public FIFO20Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public FIFO20Users()		{  }
	public FIFO20Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.FIFO20Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public FIFO20Users self;
		public void updateSelf(ActorReference actorReference) {
			((FIFO20Users)actorReference).setUAL(getUAL());
			((FIFO20Users)actorReference).setUAN(getUAN());
			self = new FIFO20Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.FIFO20Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, Speaker s11, Speaker s12, Speaker s13, Speaker s14, Speaker s15, Speaker s16, Speaker s17, Speaker s18, Speaker s19, Speaker s20, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 1: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 2: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 3: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 4: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 5: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 6: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 7: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 8: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 9: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 10: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 11: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 12: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 13: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 14: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 15: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 16: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 17: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 18: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 19: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 20: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, true };
