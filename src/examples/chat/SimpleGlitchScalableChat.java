...
public class SimpleGlitchScalableChat extends UniversalActor  {
	public static void main(String args[]) {
		...
		SimpleGlitchScalableChat instance = (SimpleGlitchScalableChat)new SimpleGlitchScalableChat(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleGlitchScalableChat(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleGlitchScalableChat.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleGlitchScalableChat(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleGlitchScalableChat.getReferenceByLocation(new UAL(ual)); }
	public SimpleGlitchScalableChat(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleGlitchScalableChat(boolean o, UAL __ual)	{ super(false,__ual); }
	public SimpleGlitchScalableChat(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public SimpleGlitchScalableChat(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public SimpleGlitchScalableChat(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public SimpleGlitchScalableChat()		{  }
	public SimpleGlitchScalableChat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.SimpleGlitchScalableChat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public SimpleGlitchScalableChat self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleGlitchScalableChat)actorReference).setUAL(getUAL());
			((SimpleGlitchScalableChat)actorReference).setUAN(getUAN());
			self = new SimpleGlitchScalableChat(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.SimpleGlitchScalableChat$State" );
			...
			if (end) {question = num_users;
				...
				if (i==question) {{
					for (int j = 1; j<=num_messages; j++)					{
						...
						{
							Object _arguments[] = { "User "+i+": Poll Question "+values.get(i-1)+".", false, true, false, num_messages, (num_users-1)*num_messages, true };
					...
					for (int j = 1; j<=num_messages; j++)					{
						...
						{
							Object _arguments[] = { "User "+i+": Poll Answer "+values.get(i-1)+".", false, false, true, num_messages, (num_users-1)*num_messages, true };
							Message message = new Message( self, speaker, "broadcastSend", _arguments, null, null );
							__messages.add( message );
						}
					}
