...
public class Causal50Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		Causal50Users instance = (Causal50Users)new Causal50Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Causal50Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Causal50Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Causal50Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Causal50Users.getReferenceByLocation(new UAL(ual)); }
	public Causal50Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public Causal50Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public Causal50Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Causal50Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Causal50Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Causal50Users()		{  }
	public Causal50Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.Causal50Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Causal50Users self;
		public void updateSelf(ActorReference actorReference) {
			((Causal50Users)actorReference).setUAL(getUAL());
			((Causal50Users)actorReference).setUAN(getUAN());
			self = new Causal50Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.Causal50Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, Speaker s11, Speaker s12, Speaker s13, Speaker s14, Speaker s15, Speaker s16, Speaker s17, Speaker s18, Speaker s19, Speaker s20, Speaker s21, Speaker s22, Speaker s23, Speaker s24, Speaker s25, Speaker s26, Speaker s27, Speaker s28, Speaker s29, Speaker s30, Speaker s31, Speaker s32, Speaker s33, Speaker s34, Speaker s35, Speaker s36, Speaker s37, Speaker s38, Speaker s39, Speaker s40, Speaker s41, Speaker s42, Speaker s43, Speaker s44, Speaker s45, Speaker s46, Speaker s47, Speaker s48, Speaker s49, Speaker s50, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 1: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 2: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 3: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 4: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 5: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 6: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 7: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 8: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 9: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 10: Question "+values.get(i-1)+".", false, true, false, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 11: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 12: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 13: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 14: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 15: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 16: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 17: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 18: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 19: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 20: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 21: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 22: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 23: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 24: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 25: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 26: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 27: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 28: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 29: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 30: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 31: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 32: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 33: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 34: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 35: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 36: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 37: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 38: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 39: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 40: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 41: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 42: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 43: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 44: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 45: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 46: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 47: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 48: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 49: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 50: Answer "+values.get(i-1)+".", false, false, true, num_messages, 49*num_messages, true };
