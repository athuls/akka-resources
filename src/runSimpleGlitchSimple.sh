...
java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id5 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id5 > ./logs/speaker4.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id6 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id6 > ./logs/speaker5.txt 2>&1 &
