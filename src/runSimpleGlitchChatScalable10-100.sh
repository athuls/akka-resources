...
java -Xmx1024m -cp .:./libs/salsa1.1.5.jar -Dnodie  -Dnogc examples.chat.ScalableCreateUsers uan://localhost:3030/id1 /home/rohankasivis/akka-resources-11-02-19/src/logs 10 100 1 200  localhost SimpleGlitchSimple  > ./logs/ScalableCreateUsers.txt 2>&1 &

sleep 30s

java -X4098m -cp .:./libs/salsa1.1.5.jar -Dnodie  -Dnogc examples.chat.SimpleGlitchScalableChat uan://localhost:3030/id1 /home/rohankasivis/akka-resources-11-02-19/src/logs 10 100 1 200 localhost > ./logs/simpleGlitchSimple.txt 2>&1 &
