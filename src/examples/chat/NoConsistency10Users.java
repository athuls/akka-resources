...
public class NoConsistency10Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		NoConsistency10Users instance = (NoConsistency10Users)new NoConsistency10Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NoConsistency10Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NoConsistency10Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NoConsistency10Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NoConsistency10Users.getReferenceByLocation(new UAL(ual)); }
	public NoConsistency10Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public NoConsistency10Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public NoConsistency10Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NoConsistency10Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NoConsistency10Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NoConsistency10Users()		{  }
	public NoConsistency10Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.NoConsistency10Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NoConsistency10Users self;
		public void updateSelf(ActorReference actorReference) {
			((NoConsistency10Users)actorReference).setUAL(getUAL());
			((NoConsistency10Users)actorReference).setUAN(getUAN());
			self = new NoConsistency10Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.NoConsistency10Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, int num_messages) {
			ArrayList values = new ArrayList();
			for (int i = 1; i<=num_messages; i++)values.add(i);
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s1<-broadcastSend("User 1: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 1: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s2<-broadcastSend("User 2: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 2: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s3<-broadcastSend("User 3: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 3: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s4<-broadcastSend("User 4: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 4: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s5<-broadcastSend("User 5: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 5: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s6<-broadcastSend("User 6: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 6: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s7<-broadcastSend("User 7: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 7: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s8<-broadcastSend("User 8: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 8: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s9<-broadcastSend("User 9: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 9: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s10<-broadcastSend("User 10: Random message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, false)
				{
					Object _arguments[] = { "User 10: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, false };
		...
		public void act(String args[]) {
			try {
				...
				Instant begin = Instant.now();
				{
					...
					// chatSession(speaker1, speaker2, speaker3, speaker4, speaker5, speaker6, speaker7, speaker8, speaker9, speaker10, num_messages)
					{
						Object _arguments[] = { speaker1, speaker2, speaker3, speaker4, speaker5, speaker6, speaker7, speaker8, speaker9, speaker10, num_messages };
