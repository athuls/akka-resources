...
public class FIFOScalableChat extends UniversalActor  {
	public static void main(String args[]) {
		...
		FIFOScalableChat instance = (FIFOScalableChat)new FIFOScalableChat(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FIFOScalableChat(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FIFOScalableChat.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FIFOScalableChat(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FIFOScalableChat.getReferenceByLocation(new UAL(ual)); }
	public FIFOScalableChat(boolean o, UAN __uan)	{ super(false,__uan); }
	public FIFOScalableChat(boolean o, UAL __ual)	{ super(false,__ual); }
	public FIFOScalableChat(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public FIFOScalableChat(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public FIFOScalableChat(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public FIFOScalableChat()		{  }
	public FIFOScalableChat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.FIFOScalableChat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public FIFOScalableChat self;
		public void updateSelf(ActorReference actorReference) {
			((FIFOScalableChat)actorReference).setUAL(getUAL());
			((FIFOScalableChat)actorReference).setUAN(getUAN());
			self = new FIFOScalableChat(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.FIFOScalableChat$State" );
		...
		public void chatSession(int num_users, int num_messages, String server_ref) {
			...
			for (int i = 1; i<=num_users; i++){
				...
				for (int j = 1; j<=num_messages; j++)				{
					// speaker<-broadcastSend("User "+i+": Ordered statement "+values.get(i-1)+".", true, false, false, 0, (num_users-1)*num_messages, true)
					{
						Object _arguments[] = { "User "+i+": Ordered statement "+values.get(i-1)+".", true, false, false, new Integer(0), (num_users-1)*num_messages, true };
