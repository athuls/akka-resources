...
public class OrderedChat extends UniversalActor  {
	public static void main(String args[]) {
		...
		OrderedChat instance = (OrderedChat)new OrderedChat(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new OrderedChat(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return OrderedChat.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new OrderedChat(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return OrderedChat.getReferenceByLocation(new UAL(ual)); }
	public OrderedChat(boolean o, UAN __uan)	{ super(false,__uan); }
	public OrderedChat(boolean o, UAL __ual)	{ super(false,__ual); }
	public OrderedChat(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public OrderedChat(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public OrderedChat(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public OrderedChat()		{  }
	public OrderedChat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.OrderedChat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public OrderedChat self;
		public void updateSelf(ActorReference actorReference) {
			((OrderedChat)actorReference).setUAL(getUAL());
			((OrderedChat)actorReference).setUAN(getUAN());
			self = new OrderedChat(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.OrderedChat$State" );
