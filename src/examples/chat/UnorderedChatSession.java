...
public class UnorderedChatSession extends UniversalActor  {
	public static void main(String args[]) {
		...
		UnorderedChatSession instance = (UnorderedChatSession)new UnorderedChatSession(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new UnorderedChatSession(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return UnorderedChatSession.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new UnorderedChatSession(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return UnorderedChatSession.getReferenceByLocation(new UAL(ual)); }
	public UnorderedChatSession(boolean o, UAN __uan)	{ super(false,__uan); }
	public UnorderedChatSession(boolean o, UAL __ual)	{ super(false,__ual); }
	public UnorderedChatSession(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public UnorderedChatSession(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public UnorderedChatSession(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public UnorderedChatSession()		{  }
	public UnorderedChatSession(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.UnorderedChatSession", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public UnorderedChatSession self;
		public void updateSelf(ActorReference actorReference) {
			((UnorderedChatSession)actorReference).setUAL(getUAL());
			((UnorderedChatSession)actorReference).setUAN(getUAN());
			self = new UnorderedChatSession(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.UnorderedChatSession$State" );
