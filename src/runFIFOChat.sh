...
java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id7 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id7 > ./logs/speaker6FIFOSimple.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id8 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id8 > ./logs/speaker7FIFOSimple.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id9 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id9 > ./logs/speaker8FIFOSimple.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id10 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id10 > ./logs/speaker9FIFOSimple.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Duan=uan:\\localhost:3030\id11 examples.chat.SpeakerKtKt uan:\\localhost:3030\id1 uan:\\localhost:3030\id11 > ./logs/speaker10FIFOSimple.txt 2>&1 &

java -cp .:./libs/kotlin-runtime-1.2.20-dev-331.jar:./libs/salsa1.1.5.jar -Dnodie examples.chat.FIFOAdvancedChat uan:\\localhost:3030\id2 uan:\\localhost:3030\id3 uan:\\localhost:3030\id4 uan:\\localhost:3030\id5 uan:\\localhost:3030\id6 uan:\\localhost:3030\id7 uan:\\localhost:3030\id8 uan:\\localhost:3030\id9 uan:\\localhost:3030\id10 uan:\\localhost:3030\id11 > ./logs/simpleFIFO.txt 2>&1 &

sleep 30s

#python ParseFIFO.py >> logs/FIFOChatResults.txt
