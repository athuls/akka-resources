...
public class HelloWorld extends UniversalActor  {
	...
	public HelloWorld(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "HelloWorld", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void act(String arguments[]) {
			{
				// standardOutput<-println("Printing from SALSA:")
				{
					Object _arguments[] = { "Printing from SALSA:" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			{
				// standardOutput<-println("The number I got from Kotlin code: "+arguments[0])
				{
					Object _arguments[] = { "The number I got from Kotlin code: "+arguments[0] };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
