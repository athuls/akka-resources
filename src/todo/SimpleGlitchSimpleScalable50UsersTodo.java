...
public class SimpleGlitchSimpleScalable50UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		SimpleGlitchSimpleScalable50UsersTodo instance = (SimpleGlitchSimpleScalable50UsersTodo)new SimpleGlitchSimpleScalable50UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleGlitchSimpleScalable50UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleGlitchSimpleScalable50UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleGlitchSimpleScalable50UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleGlitchSimpleScalable50UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public SimpleGlitchSimpleScalable50UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleGlitchSimpleScalable50UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public SimpleGlitchSimpleScalable50UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public SimpleGlitchSimpleScalable50UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public SimpleGlitchSimpleScalable50UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public SimpleGlitchSimpleScalable50UsersTodo()		{  }
	public SimpleGlitchSimpleScalable50UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.SimpleGlitchSimpleScalable50UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public SimpleGlitchSimpleScalable50UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleGlitchSimpleScalable50UsersTodo)actorReference).setUAL(getUAL());
			((SimpleGlitchSimpleScalable50UsersTodo)actorReference).setUAN(getUAN());
			self = new SimpleGlitchSimpleScalable50UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.SimpleGlitchSimpleScalable50UsersTodo$State" );
