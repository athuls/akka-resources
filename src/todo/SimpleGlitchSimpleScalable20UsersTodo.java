...
public class SimpleGlitchSimpleScalable20UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		SimpleGlitchSimpleScalable20UsersTodo instance = (SimpleGlitchSimpleScalable20UsersTodo)new SimpleGlitchSimpleScalable20UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleGlitchSimpleScalable20UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleGlitchSimpleScalable20UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleGlitchSimpleScalable20UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleGlitchSimpleScalable20UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public SimpleGlitchSimpleScalable20UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleGlitchSimpleScalable20UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public SimpleGlitchSimpleScalable20UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public SimpleGlitchSimpleScalable20UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public SimpleGlitchSimpleScalable20UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public SimpleGlitchSimpleScalable20UsersTodo()		{  }
	public SimpleGlitchSimpleScalable20UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.SimpleGlitchSimpleScalable20UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public SimpleGlitchSimpleScalable20UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleGlitchSimpleScalable20UsersTodo)actorReference).setUAL(getUAL());
			((SimpleGlitchSimpleScalable20UsersTodo)actorReference).setUAN(getUAN());
			self = new SimpleGlitchSimpleScalable20UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.SimpleGlitchSimpleScalable20UsersTodo$State" );
