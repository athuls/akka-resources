...
public class OrderedChatSessionRunner extends UniversalActor  {
	public static void main(String args[]) {
		...
		OrderedChatSessionRunner instance = (OrderedChatSessionRunner)new OrderedChatSessionRunner(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new OrderedChatSessionRunner(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return OrderedChatSessionRunner.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new OrderedChatSessionRunner(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return OrderedChatSessionRunner.getReferenceByLocation(new UAL(ual)); }
	public OrderedChatSessionRunner(boolean o, UAN __uan)	{ super(false,__uan); }
	public OrderedChatSessionRunner(boolean o, UAL __ual)	{ super(false,__ual); }
	public OrderedChatSessionRunner(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public OrderedChatSessionRunner(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public OrderedChatSessionRunner(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public OrderedChatSessionRunner()		{  }
	public OrderedChatSessionRunner(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.OrderedChatSessionRunner", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public OrderedChatSessionRunner self;
		public void updateSelf(ActorReference actorReference) {
			((OrderedChatSessionRunner)actorReference).setUAL(getUAL());
			((OrderedChatSessionRunner)actorReference).setUAN(getUAN());
			self = new OrderedChatSessionRunner(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.OrderedChatSessionRunner$State" );
