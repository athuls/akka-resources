...
java -cp libs/salsa1.1.5.jar:. todo.SimpleGlitchSimpleTodo uan:\\localhost:3030\id2 uan:\\localhost:3030\id3 uan:\\localhost:3030\id4 uan:\\localhost:3030\id5 uan:\\localhost:3030\id6 Jason Mason Dan Chinki pinku uan:\\localhost:3030\id7 > ./taskLogs/simpleCausalTodo.txt 2>&1 &
