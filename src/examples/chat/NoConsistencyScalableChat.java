...
public class NoConsistencyScalableChat extends UniversalActor  {
	public static void main(String args[]) {
		...
		NoConsistencyScalableChat instance = (NoConsistencyScalableChat)new NoConsistencyScalableChat(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NoConsistencyScalableChat(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NoConsistencyScalableChat.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NoConsistencyScalableChat(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NoConsistencyScalableChat.getReferenceByLocation(new UAL(ual)); }
	public NoConsistencyScalableChat(boolean o, UAN __uan)	{ super(false,__uan); }
	public NoConsistencyScalableChat(boolean o, UAL __ual)	{ super(false,__ual); }
	public NoConsistencyScalableChat(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NoConsistencyScalableChat(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NoConsistencyScalableChat(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NoConsistencyScalableChat()		{  }
	public NoConsistencyScalableChat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.NoConsistencyScalableChat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NoConsistencyScalableChat self;
		public void updateSelf(ActorReference actorReference) {
			((NoConsistencyScalableChat)actorReference).setUAL(getUAL());
			((NoConsistencyScalableChat)actorReference).setUAN(getUAN());
			self = new NoConsistencyScalableChat(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.NoConsistencyScalableChat$State" );
		...
		public void chatSession(int num_users, int num_messages, String server_ref) {
			...
			for (int i = 1; i<=num_users; i++){
				...
				for (int j = 1; j<=num_messages; j++)				{
					// speaker<-broadcastSend("User "+i+": Random statement "+values.get(i-1)+".", true, false, false, 0, (num_users-1)*num_messages, false)
					{
						Object _arguments[] = { "User "+i+": Random statement "+values.get(i-1)+".", true, false, false, new Integer(0), (num_users-1)*num_messages, false };
		...
		public void act(String args[]) {
			if (args.length!=0) {{
				...
				Instant begin = Instant.now();
				{
					...
					// chatSession(5, 3)
					{
						Object _arguments[] = { new Integer(5), new Integer(3) };
