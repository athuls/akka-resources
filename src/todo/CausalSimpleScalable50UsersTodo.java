...
public class CausalSimpleScalable50UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		CausalSimpleScalable50UsersTodo instance = (CausalSimpleScalable50UsersTodo)new CausalSimpleScalable50UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CausalSimpleScalable50UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CausalSimpleScalable50UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CausalSimpleScalable50UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CausalSimpleScalable50UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public CausalSimpleScalable50UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public CausalSimpleScalable50UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public CausalSimpleScalable50UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public CausalSimpleScalable50UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public CausalSimpleScalable50UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public CausalSimpleScalable50UsersTodo()		{  }
	public CausalSimpleScalable50UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.CausalSimpleScalable50UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public CausalSimpleScalable50UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((CausalSimpleScalable50UsersTodo)actorReference).setUAL(getUAL());
			((CausalSimpleScalable50UsersTodo)actorReference).setUAN(getUAN());
			self = new CausalSimpleScalable50UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.CausalSimpleScalable50UsersTodo$State" );
