...
# Moved this section of build to a separate file for integration with Kotlin build
#################################################################################
# Compiling Kotlin code
#echo "Compiling kotlin code"
#kotlinc examples/chat/SpeakerKt.kt -d SpeakerKt.jar
#kotlinc examples/chat/ChatKt.kt -d ChatKt.jar
