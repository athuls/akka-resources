...
public class CausalSimpleScalable10UsersTodo extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		CausalSimpleScalable10UsersTodo instance = (CausalSimpleScalable10UsersTodo)new CausalSimpleScalable10UsersTodo(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CausalSimpleScalable10UsersTodo(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CausalSimpleScalable10UsersTodo.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CausalSimpleScalable10UsersTodo(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CausalSimpleScalable10UsersTodo.getReferenceByLocation(new UAL(ual)); }
	public CausalSimpleScalable10UsersTodo(boolean o, UAN __uan)	{ super(false,__uan); }
	public CausalSimpleScalable10UsersTodo(boolean o, UAL __ual)	{ super(false,__ual); }

	public CausalSimpleScalable10UsersTodo(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public CausalSimpleScalable10UsersTodo(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public CausalSimpleScalable10UsersTodo(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public CausalSimpleScalable10UsersTodo()		{  }
	public CausalSimpleScalable10UsersTodo(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.CausalSimpleScalable10UsersTodo");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public CausalSimpleScalable10UsersTodo self;
		public void updateSelf(ActorReference actorReference) {
			((CausalSimpleScalable10UsersTodo)actorReference).setUAL(getUAL());
			((CausalSimpleScalable10UsersTodo)actorReference).setUAN(getUAN());
			self = new CausalSimpleScalable10UsersTodo(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.CausalSimpleScalable10UsersTodo$State" );
