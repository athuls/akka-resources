...
public class FIFOSimpleChat extends UniversalActor  {
	public static void main(String args[]) {
		...
		FIFOSimpleChat instance = (FIFOSimpleChat)new FIFOSimpleChat(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FIFOSimpleChat(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FIFOSimpleChat.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FIFOSimpleChat(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FIFOSimpleChat.getReferenceByLocation(new UAL(ual)); }
	public FIFOSimpleChat(boolean o, UAN __uan)	{ super(false,__uan); }
	public FIFOSimpleChat(boolean o, UAL __ual)	{ super(false,__ual); }
	public FIFOSimpleChat(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public FIFOSimpleChat(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public FIFOSimpleChat(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public FIFOSimpleChat()		{  }
	public FIFOSimpleChat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.FIFOSimpleChat", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public FIFOSimpleChat self;
		public void updateSelf(ActorReference actorReference) {
			((FIFOSimpleChat)actorReference).setUAL(getUAL());
			((FIFOSimpleChat)actorReference).setUAN(getUAN());
			self = new FIFOSimpleChat(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.FIFOSimpleChat$State" );
