...
public class FIFOSimpleScalableTodo100 extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		FIFOSimpleScalableTodo100 instance = (FIFOSimpleScalableTodo100)new FIFOSimpleScalableTodo100(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FIFOSimpleScalableTodo100(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FIFOSimpleScalableTodo100.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FIFOSimpleScalableTodo100(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FIFOSimpleScalableTodo100.getReferenceByLocation(new UAL(ual)); }
	public FIFOSimpleScalableTodo100(boolean o, UAN __uan)	{ super(false,__uan); }
	public FIFOSimpleScalableTodo100(boolean o, UAL __ual)	{ super(false,__ual); }

	public FIFOSimpleScalableTodo100(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public FIFOSimpleScalableTodo100(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public FIFOSimpleScalableTodo100(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public FIFOSimpleScalableTodo100()		{  }
	public FIFOSimpleScalableTodo100(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "todo.FIFOSimpleScalableTodo100");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public FIFOSimpleScalableTodo100 self;
		public void updateSelf(ActorReference actorReference) {
			((FIFOSimpleScalableTodo100)actorReference).setUAL(getUAL());
			((FIFOSimpleScalableTodo100)actorReference).setUAN(getUAN());
			self = new FIFOSimpleScalableTodo100(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "todo.FIFOSimpleScalableTodo100$State" );
		...
		public void todoSession(ArrayList users, ArrayList userNames, int num_users, int num_messages, String server_ref, String logDirectory, TaskList taskList) {
			...
			for (int i = 0; i<users.size(); i++){
				...
				for (int j = 1; j<=num_messages; j++){
					...
					{
						// registeredUser<-addTaskToList(taskList, "User"+i+": Ordered task "+values.get(j-1)+".", (String)userNames.get(i), taskname, false, 0, (num_users-1)*num_messages, true)
						{
							Object _arguments[] = { taskList, "User"+i+": Ordered task "+values.get(j-1)+".", (String)userNames.get(i), taskname, false, new Integer(0), (num_users-1)*num_messages, true };
