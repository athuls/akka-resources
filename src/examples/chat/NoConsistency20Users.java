...
public class NoConsistency20Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		NoConsistency20Users instance = (NoConsistency20Users)new NoConsistency20Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NoConsistency20Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NoConsistency20Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NoConsistency20Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NoConsistency20Users.getReferenceByLocation(new UAL(ual)); }
	public NoConsistency20Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public NoConsistency20Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public NoConsistency20Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NoConsistency20Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NoConsistency20Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NoConsistency20Users()		{  }
	public NoConsistency20Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.NoConsistency20Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NoConsistency20Users self;
		public void updateSelf(ActorReference actorReference) {
			((NoConsistency20Users)actorReference).setUAL(getUAL());
			((NoConsistency20Users)actorReference).setUAN(getUAN());
			self = new NoConsistency20Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.NoConsistency20Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, Speaker s11, Speaker s12, Speaker s13, Speaker s14, Speaker s15, Speaker s16, Speaker s17, Speaker s18, Speaker s19, Speaker s20, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 1: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 2: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 3: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 4: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 5: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 6: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 7: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 8: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 9: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 10: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 11: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 12: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 13: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 14: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 15: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 16: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 17: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 18: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 19: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 20: Random message "+values.get(i-1)+".", true, false, false, new Integer(0), 19*num_messages, false };
