...
public class FIFO10Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		FIFO10Users instance = (FIFO10Users)new FIFO10Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FIFO10Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FIFO10Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FIFO10Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FIFO10Users.getReferenceByLocation(new UAL(ual)); }
	public FIFO10Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public FIFO10Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public FIFO10Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public FIFO10Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public FIFO10Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public FIFO10Users()		{  }
	public FIFO10Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.FIFO10Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public FIFO10Users self;
		public void updateSelf(ActorReference actorReference) {
			((FIFO10Users)actorReference).setUAL(getUAL());
			((FIFO10Users)actorReference).setUAN(getUAN());
			self = new FIFO10Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.FIFO10Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				// s1<-broadcastSend("User 1: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 1: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s2<-broadcastSend("User 2: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 2: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s3<-broadcastSend("User 3: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 3: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s4<-broadcastSend("User 4: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 4: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s5<-broadcastSend("User 5: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 5: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s6<-broadcastSend("User 6: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 6: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s7<-broadcastSend("User 7: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 7: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s8<-broadcastSend("User 8: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 8: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s9<-broadcastSend("User 9: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 9: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
			...
			Collections.shuffle(values);
			for (int i = 1; i<=num_messages; i++)			{
				// s10<-broadcastSend("User 10: Ordered message "+values.get(i-1)+".", true, false, false, 0, 9*num_messages, true)
				{
					Object _arguments[] = { "User 10: Ordered message "+values.get(i-1)+".", true, false, false, new Integer(0), 9*num_messages, true };
