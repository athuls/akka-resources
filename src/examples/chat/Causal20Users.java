...
public class Causal20Users extends UniversalActor  {
	public static void main(String args[]) {
		...
		Causal20Users instance = (Causal20Users)new Causal20Users(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Causal20Users(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Causal20Users.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Causal20Users(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Causal20Users.getReferenceByLocation(new UAL(ual)); }
	public Causal20Users(boolean o, UAN __uan)	{ super(false,__uan); }
	public Causal20Users(boolean o, UAL __ual)	{ super(false,__ual); }
	public Causal20Users(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Causal20Users(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Causal20Users(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Causal20Users()		{  }
	public Causal20Users(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.Causal20Users", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Causal20Users self;
		public void updateSelf(ActorReference actorReference) {
			((Causal20Users)actorReference).setUAL(getUAL());
			((Causal20Users)actorReference).setUAN(getUAN());
			self = new Causal20Users(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.Causal20Users$State" );
		...
		public void chatSession(Speaker s1, Speaker s2, Speaker s3, Speaker s4, Speaker s5, Speaker s6, Speaker s7, Speaker s8, Speaker s9, Speaker s10, Speaker s11, Speaker s12, Speaker s13, Speaker s14, Speaker s15, Speaker s16, Speaker s17, Speaker s18, Speaker s19, Speaker s20, int num_messages) {
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 1: Question "+values.get(i-1)+".", false, true, false, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 2: Question "+values.get(i-1)+".", false, true, false, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 3: Question "+values.get(i-1)+".", false, true, false, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 4: Question "+values.get(i-1)+".", false, true, false, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 5: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 6: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 7: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 8: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 9: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 10: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 11: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 12: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 13: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 14: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 15: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 16: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 17: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 18: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 19: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
			...
			for (int i = 1; i<=num_messages; i++)			{
				...
				{
					Object _arguments[] = { "User 20: Answer "+values.get(i-1)+".", false, false, true, num_messages, 19*num_messages, true };
