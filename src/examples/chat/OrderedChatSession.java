...
public class OrderedChatSession extends UniversalActor  {
	public static void main(String args[]) {
		...
		OrderedChatSession instance = (OrderedChatSession)new OrderedChatSession(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new OrderedChatSession(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return OrderedChatSession.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new OrderedChatSession(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return OrderedChatSession.getReferenceByLocation(new UAL(ual)); }
	public OrderedChatSession(boolean o, UAN __uan)	{ super(false,__uan); }
	public OrderedChatSession(boolean o, UAL __ual)	{ super(false,__ual); }
	public OrderedChatSession(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public OrderedChatSession(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public OrderedChatSession(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public OrderedChatSession()		{  }
	public OrderedChatSession(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.chat.OrderedChatSession", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public OrderedChatSession self;
		public void updateSelf(ActorReference actorReference) {
			((OrderedChatSession)actorReference).setUAL(getUAL());
			((OrderedChatSession)actorReference).setUAN(getUAN());
			self = new OrderedChatSession(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.chat.OrderedChatSession$State" );
		...
		public void chatSession(ChatSession s1, ChatSession s2, ChatSession s3) {
			{
				Token token_2_0 = new Token();
				Token token_2_1 = new Token();
				// s1<-broadcastSend("Sample message form ChatSession 1")
				{
					Object _arguments[] = { "Sample message form ChatSession 1" };
				...
				{
					Object _arguments[] = { "Sample message from ChatSession 2" };
				...
				{
					Object _arguments[] = { "Sample message from ChatSession 3" };
					Message message = new Message( self, s2, "broadcastSend", _arguments, token_2_1, currentMessage.getContinuationToken() );
					__messages.add( message );
				}
