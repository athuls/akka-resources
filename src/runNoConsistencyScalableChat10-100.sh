...
java -Xmx1024m -cp .:./libs/salsa1.1.5.jar -Dnodie  -Dnogc examples.chat.ScalableCreateUsers uan://localhost:3030/id1 /home/rohankasivis/akka-resources-11-02-19/src/logs 10 100 100 200  localhost NoConsistencySimple > ./logs/ScalableCreateUsers.txt 2>&1 &

sleep 30s

java -Xmx4096m  -cp .:./libs/salsa1.1.5.jar  -Dnogc -Dnodie examples.chat.NoConsistencyScalableChat uan://localhost:3030/id1 /home/rohankasivis/akka-resources-11-02-19/src 10 100 100 200 localhost > ./logs/simpleNoConsistency.txt 2>&1 &
